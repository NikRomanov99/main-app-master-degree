...
open class RoleRecord() : UpdatableRecordImpl<RoleRecord>(Role.ROLE), Record3<Long?, String?, String?> {
     ...
     * Create a detached, initialised RoleRecord
     */
    constructor(value: ru.rsu.app.database.generated.tables.pojos.Role?): this() {
        if (value != null) {
            this.id = value.id
